...
u1 = User.create(first_name: "Raúl", last_name: "Doe", email: "raul@example.org", password: "hola.123", role: "teacher")
u2 = User.create(first_name: "Estéban", last_name: "Roe", email: "esteban@example.org", password: "hola.123", role: "student")
